...
const FireBase: React.FC<IconProps> = ({ height = "24px", width = "24px" }) => {
  return (
    ...
    <path d="M5.8,24.6l.17-.237L13.99,9.149l.017-.161L10.472,2.348a.656.656,0,0,0-1.227.207Z" style={{fill:"#ffc24a"}}/>
    ...
    <path d="M16.537,13.9l2.559-2.62L16.537,6.4a.589.589,0,0,0-1.074-.047L14.049,9.082l-.042.139Z" style={{fill:"#ffa50e"}}/>
